/* G:\gsoap\gsoap\bin\win32\myweb.h
   Generated by wsdl2h 2.8.30 from G:\gsoap\gsoap\bin\win32\myweb.wsdl and typemap.dat
   2017-03-08 10:02:24 GMT
...
@note HINTS:
 - Run soapcpp2 on G:\gsoap\gsoap\bin\win32\myweb.h to generate the SOAP/XML processing logic.
...
@code
  int soap_call_ns2__get_server_status(
    ...
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    wsdl__xsd_string                    cmd,
    // output parameters:
    wsdl__xsd_string                   &status
  );
@endcode
...
int ns2__get_server_status(
    wsdl__xsd_string                    cmd,	///< Input parameter
    wsdl__xsd_string                   &status	///< Output parameter
);
...
/* End of G:\gsoap\gsoap\bin\win32\myweb.h */
