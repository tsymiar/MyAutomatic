...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.8.30 2017-03-08 10:02:14 GMT")
...
{	struct api__encrypt soap_tmp_api__encrypt;
	...
	*out = NULL;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (out && soap_tmp_api__encryptResponse->out)
		*out = *soap_tmp_api__encryptResponse->out;
	return soap_closesock(soap);
}
